...
const features = [
  {
    ...
    title: ["Home", "Care"],
    descriptions: [
      "We provide one-of-a-kind fragrance options for hair,",
      "body, and skin care products thanks to our broad",
      "fragrance collection and innovative fragrance staff.",
      "",
      "As the needs of our customers evolve in response to",
      "shifting worldwide market conditions, we anticipate their",
      "needs and provide them with innovative solutions",
      "developed by our team of recognized experts in the field",
      "of scent compound creation.",
      "",
      "Personal Hygiene Products Like Shampoo, Conditioner,",
      "Body Wash, Face Wash, Exfoliants, Towelettes, and",
      "Deodorant.",
    ],
  },
  {
    ...
    title: ["Personal", "Care"],
    descriptions: [
      "By pushing the envelope, our talented perfumers from",
      "around the world have come up with some of the most",
      "original and uplifting scent combinations ever.",
      "\n",
      "Our perfumery expertise and the quality of all Luxeo",
      "fragrances are ensured by our talented and innovative",
      "perfumers, a wide variety of hand-picked premium",
      "ingredients sourced from throughout the world, and",
      "state-of-the-art Luxeo technologies.",
    ],
  },
  {
    id: "fineperfumery",
    ...
    descriptions: [
      "Our extensive fragrance library allows us to tailor our",
      "solutions to meet the needs of niche markets and",
      "consumer preferences for air care, laundry care, and",
      "other functional items.",
      "",
      "Our plans are grounded on client and consumer",
      "needs and market realities, but we always push the",
      "envelope to surprise and delight them.",
      "",
      "Cleaners for the Kitchen and Bathroom, as well as All-",
      "Purpose Cleaners, Fabric Softeners, Air Care ",
      "Products, Laundry Detergents, and Dishwashers.",
    ],
  },
];
